...
‭ removed NaN values and done some initial data exploration to understand what the data‬
‭ is telling us. Next I need to do my Chi squared test and evaluate the results, make my‬
‭ presentation draft, and make my final presentation. I am 90% done with these steps.‬
‭ What has been accomplished towards the major goals in the past week?‬‭ (20 points)‬
‭ This week I finished my Chi squared test and plotted my results on two bar graphs. One is‬
‭ CAHOOTS observations with two bars one from before and one from after August 2024‬
‭ and the other is the same but for all the not cahoots observations. Then I plotted my‬
‭ p-values as a bar chart with a line showing the 0.05 cutoff.‬
...
‭ data set to help CAHOOTS with their data analysis. Since we are in a time of uncertainty‬
‭ for CAHOOTS any data analysis they can get to help their chances of continuing to help‬
‭ the community is making a difference.‬
‭ Changes in approach‬‭‬
‭ There have not been any changes in my approach so far this week.‬
